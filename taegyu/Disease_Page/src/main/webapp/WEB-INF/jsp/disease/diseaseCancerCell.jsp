...
<body>
<a href="/disease/diseaseInfo">
	<img src="/resource/img/5_CancerCell.png" class="exampleImg" alt="암세포이미지"/>
</a>
<h1>암 발생원인과 대표 질환</h1>
...
<table class="exampleFood">
    ...
    <tr>
    	<td class="food-info">
			<ul>
				<li class="helpFood">통밀
				<li class="helpFood">해조류
				<li class="helpFood">지방 제거한 살코기
			</ul>
    	</td>
    	<td class="food-info">
    		<ul>
				<li class="escapeFood">알코올
				<li class="escapeFood">가공육
				<li class="escapeFood">매운 음식
			</ul>
    	</td>
    </tr>
</table>
