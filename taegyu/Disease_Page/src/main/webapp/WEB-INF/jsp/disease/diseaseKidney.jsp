...
<a href="/disease/diseaseInfo">
	<img src="/resource/img/4_Kidney.png" class="exampleImg" alt="신장질환이미지"/>
</a>
...
<table class="exampleFood">
    ...
    <tr>
    	<td class="food-info">
			<ul>
				<li class="helpFood">양파
				<li class="helpFood">양배추
				<li class="helpFood">아스파라거스
			</ul>
    	</td>
    	<td class="food-info">
    		<ul>
				<li class="escapeFood">밀가루
				<li class="escapeFood">정제염
				<li class="escapeFood">동물성 식품
			</ul>
    	</td>
    </tr>
</table>
